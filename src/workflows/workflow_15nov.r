...
FEintra_manual_con_cruces <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_cruces.r"
...
HT_tuning_base <- function( pinputexps, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    max_bin = 50L, # lo debo dejar fijo, no participa de la BO
...
wf_feat_cruzadas_htnuevo <- function( pnombrewf )
{
