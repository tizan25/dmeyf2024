...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.05
  ...
  param_local$train$undersampling <- 0.05
...
KA_evaluate_kaggle <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/2603_KA_evaluate_kaggle.r"
...
wf_tercera_sinsemi_CV <- function( pnombrewf )
{
