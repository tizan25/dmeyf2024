#!/usr/bin/env Rscript
cat( "ETAPA  1301_FE_intrames_manual_cruces.r  INIT\n")
...
cat( "ETAPA  1301_FE_intrames_manual_cruces.r  START\n")
action_inicializar() 
...
cat( "ETAPA  1301_FE_intrames_manual_cruces.r  END\n")
