...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  if( atributos_presentes( c("mpayroll", "cliente_edad") )) {
    ...
    # si el valor es Nan, dejo el valor original de mpayroll
    dataset[is.nan(mpayroll_sobre_edad), mpayroll_sobre_edad := mpayroll]
  }
  ...
  # Crear un atributo que sume los atributos de transacciones, chequeando que existan antes de sumarlos
  atributos_trx = c("ctrx_quarter_normalizado", "ctarjeta_debito_transacciones",
