...
envg$EXPENV$exp_dir <- "~/buckets/b1/expw228/"
envg$EXPENV$wf_dir <- "~/buckets/b1/flow228/"
...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$atributos_eliminar <- c( "tmobile_app", "cmobile_app_trx", "Visa_mpagosdolares" )
  param_local$semilla <- NULL  # no usa semilla, es deterministico
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1302_FE_intrames_manual.r"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.04
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c(
    202107, 202106, 202105, 202009, 202008, 202007, 202006, 202005,
  ...
  param_local$train$training <- c(
    202105, 202009, 202008, 202007, 
    202006, 202005, 201909, 201908, 201907, 201906, 201905
  )
...
wf_SEMI_sep_orden228_menosmeses <- function( pnombrewf )
{
...
wf_SEMI_sep_orden228_menosmeses()
